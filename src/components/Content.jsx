...
function Content() {
  ...
  const filosofos = {
    Nietzsche: {
      ...
      obras:
        "Assim Falou Zaratustra, Além do Bem e do Mal, A Genealogia da Moral",
    ...
    <div className="content">
      ...
      {resultado ? (
        <div className="resultado">
          ...
          <p>
            <strong>Obras Destacadas:</strong> {resultado.obras}
          </p>
          <p>
  <strong>Frases marcantes:</strong>
  <ul>
    {resultado.frases.map((frase, index) => (
      <li key={index}>{frase}</li>
        ...
        <p className="mensagem-erro">Nenhum filósofo encontrado. Tente novamente.</p>
      )}
    </div>
  );
}
